...
/**
 * All events triggered by Treeliable extend {@code ChopEvent}. Listeners can alter how and when chopping occurs.
 */
abstract public class ChopEvent extends Event {
