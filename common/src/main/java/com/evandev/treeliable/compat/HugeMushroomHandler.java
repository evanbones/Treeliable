...
public class HugeMushroomHandler implements ITreeBlock {
    private static final Lazy<Set<Block>> logs = new Lazy<>(() -> ModConfig.getIdentifiedBlocks(ModConfig.get().hugeMushroomLogs).collect(Collectors.toSet()));
